    ...
    return <div >
      ...
      <div className="">
        <div className="py-12 mx-auto max-w-7xl">
            <div className="items-center px-4 sm:px-0 sm:-mt-14 sm:col-span-4 xl:ml-28 ">
            <div className="items-center">
                {
                    ...
                    <div key={yc.id} className="py-6 border-b border-very-light-grey ">
                        ...
                        <div className="inline-block">
                            ...
                            <div className="">  
                                <Link href={`/directory/person/${yc.linkname}`}><a><div className="person-flex flex-row space-x-3 flex-nowrap md:pt-7"> 
                                ...
                                <div className="margin-left-70-0">
                                    ...
                                    {yc.subcategory.slice(0, 3).map((e) => <Link href={'/directory/' + yc.category + '/Learn-' + e.replace(' ', '-')} key={e} ><a className="flex items-center justify-center px-1 py-1 mt-0 mr-2 text-base text-center text-black no-underline truncate bg-white-smoke">{e}</a></Link>)}
                                    ...
                                    <div className="block col-span-5 md:hidden">
                                        ...
                                        {yc.subcategory.slice(0, 3).map((e) => <Link href={'/directory/' + yc.category + '/Learn-' + e.replace(' ', '-')} key={e} ><a className="flex items-center justify-center px-1 py-1 mt-2 mr-2 text-base text-center text-black no-underline truncate bg-white-smoke">{e}</a></Link>)}
