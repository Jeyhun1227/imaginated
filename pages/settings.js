    ...
    <div className="">
        ...
        <section className="px-4 sm:px-0">
            <div className="pt-6 mx-auto max-w-7xl">
                <Tab.Group as="div" defaultIndex={1} vertical className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
                    <div className="flex-col">
                        ...
                        <Tab.List as="ul" className="flex-col pl-0 space-y-3">
                            <Tab as="li" className={({ selected }) =>
                                        ...
                                        'flex items-center py-1 pl-3 space-x-3 hover:bg-dark-blue hover:text-white'
                                        )
                            }>
                            ...
                            <li className="flex items-center py-1 pl-3 space-x-3 hover:bg-dark-blue hover:text-white" >
                                <BoxArrowInRight/>
                    ...
                    <div className="lg:col-span-3">
                        <Tab.Panels as="div" className="border-1 border-whisper h-96 lg:h-full">
