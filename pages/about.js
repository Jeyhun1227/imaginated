    ...
    <div className="wtr-content">
      <div className="grid-container about-page-main">
            ...
            <div className='About-Main-Image'>
                <Image     layout='fill' src='https://www.imaginated.com/wp-content/uploads/2021/02/google-removebg-preview-3-300x300.png.webp' />
             </div>
             <p>
             ...
             <div className='about-page-container'>
                ...
                <div className='grid-container-about'>
                    <div className='About-second-Image'>
                        <Image     layout='fill' src='https://www.imaginated.com/wp-content/uploads/2021/01/pf-logo.png.webp' />
                    </div>
                    <div className='About-second-Image'>
                        <Image     layout='fill' src='https://www.imaginated.com/wp-content/uploads/2021/01/slrlounge-logo-300x120.png.webp' />
                    </div>
                    <div className='About-second-Image'>
                        <Image     layout='fill' src='https://www.imaginated.com/wp-content/uploads/2021/01/ezgif-1-180e1b29a6f9-removebg-preview.png.webp' />
                    </div>
                </div>
             </div>
             <div className='about-page-container'>
                ...
                <Image     layout='fill' src='https://www.imaginated.com/wp-content/uploads/2021/04/what-does-it-mean-to-be-creative.png.webp' />
                </div>
            ...
            <div className='about-page-container'>
                ...
                <p>July 2022 – Imaginated.com acquired <Link href='/presetsgalore'><a>PresetsGalore</a></Link> to further enhance their mission to be a top resources for creatives.
</p>
            </div>
      </div>
    </div>
