                  ...
                  <div className="pt-8 md:pt-2 md:w-2/5 md:mr-auto">
                      ...
                      <div className="pt-3 mx-auto mb-6 md:pt-20 md:mt-0 md:mx-0 md:mb-0">
                          <div className="flex justify-center pr-2 space-x-6 md:justify-start xl:pr-0 sm:pr-0">
                              <div>
                                  <Link href="https://www.linkedin.com/company/72624145/" legacyBehavior>
                                      <Linkedin color="#636363" size={15} />
                                  </Link>
                              </div>
                              <div>
                                  <Link href="https://www.facebook.com/iiimaginated" legacyBehavior>
                              ...
                              <div>
                                  <Link href="https://www.instagram.com/iiimaginated/" legacyBehavior>
                              ...
                              <div className="md:mt-32 sm:mx-0 sm:mb-0">
                                  <ul className="flex justify-start pl-0 mb-0">
                                      <li className="pr-2 text-xs border-r sm:text-base text-dim-grey hover:text-gray-900 sm:mb-0">
                                          <Link className= "no-underline truncate text-dim-grey" href="/privacy-policy">Privacy Policy</Link>
                                      </li>
                                      <li className="px-2 text-xs border-r sm:text-base md:border-r-0 text-dim-grey hover:text-gray-900 sm:mb-0">
                                          <Link className= "no-underline truncate text-dim-grey" href="/terms-of-service">Terms of Service</Link>
                                      </li>
                                  </ul>
                              </div>
                          ...
                          <ul>
                              ...
                              {item.links.map((items) => (
                                  <li className="mb-3" key={items.name + 'name'}>
                                      <Link
                                          className= "no-underline text-dim-grey"
                                          href={`${items.href}`}
                                          key={items.name}
                                          legacyBehavior>{items.name}</Link>
                                  </li>
                              ))}
                          </ul>
                      </div>
                                      ...
                                      <ul className="pl-2">   
                                          {item.links.map((items) => (
                                              <li className="mb-3" key={items.name + 'name_link'}>
                                                  <div className= "no-underline text-dim-grey"><Link href={`${items.href}`} key={items.name} legacyBehavior>{items.name}</Link></div>
                                              </li>
                                          ))}
                                      </ul> 
                                  </div>
