      ...
      <div class="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div class="hidden justify-between mt-2 items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-3">
            ...
            <div class="relative w-full">
                ...
                <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-96 py-2 pr-20 pl-11" placeholder="Search for a creator or category" required/>
            </div>
          </div>
          <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-4">
            <ul class="flex flex-col mb-0 mt-2 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              <li>
                <a href="#" class="block py-2 pr-4 pl-3 rounded md:bg-transparent md:text-blue-700 md:p-0 text-grey no-underline" aria-current="page">About</a>
              </li>
              <li>
                <a href="#" class="block py-2 pr-4 pl-3 border-b border-gray-100 md:border-0 md:hover:text-grey md:p-0 text-grey no-underline">Directory</a>
              </li>
              <li>
                <a href="#" class="block py-2 pr-4 pl-3 border-b border-gray-100 md:border-0 md:hover:text-grey md:p-0 text-grey no-underline">Market</a>
              </li>
              <li>
                <a href="#" class="block py-2 pr-4 pl-3 border-b border-gray-100 mr-15 md:border-0 md:hover:text-grey md:p-0 text-grey no-underline">Claim Listing</a>
              </li>
              <li>
