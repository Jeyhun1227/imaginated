    ...
    <div className="w-full bg-light-grey">
        <div className="px-4 sm:px-0">
            <div className="py-12 mx-auto sm:mx-0 max-w-7xl lg:flex lg:items-center lg:justify-between">
                ...
                <div>
                    <button type="button" onClick={(e) => {e.preventDefault();window.location.href='/login';}} className="flex items-center px-3 py-2 mr-3 text-center text-white truncate bg-dark-blue sm:mr-0">
