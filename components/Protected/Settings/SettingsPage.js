                ...
                <Tab.Group as="div" defaultIndex={0} vertical className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
                    <div className="flex flex-col">
                        ...
                        <Tab.List as="ul" className="pl-0 sm:justify-start lg:flex lg:space-y-3 sm:grid sm:grid-cols-4 lg:flex-col">
                            <li className='flex items-center py-1 pl-3 space-x-3 cursor-pointer sm:pr-auto lg:mr-0 hover:bg-dark-blue hover:text-white hover:fill-white'>
                            ...
                            <li className='flex items-center py-1 pl-3 space-x-3 cursor-pointer sm:pr-auto lg:mr-0 hover:bg-dark-blue hover:text-white'>
