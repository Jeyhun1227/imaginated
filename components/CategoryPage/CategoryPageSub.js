  ...
  return (
      <div className="mb-12">
            <div className="relative flex items-baseline justify-between pb-3 border-b border-very-light-grey">
                <div className="text-xl font-medium tracking-tight no-underline sm:text-2xl text-denim"><Link
                    href={props.category + '/Learn-' + props.subcategory.replace(' ', '-')}
                    legacyBehavior>{props.subcategory}</Link></div>
            </div>
