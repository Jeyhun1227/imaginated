  ...
  return  <div className="py-6 my-5 border-y border-very-light-grey" >
        ...
        <div className="flex flex-row items-center justify-between flex-shrink-0 truncate">
                ...
                <div className="">
                    <div className="mb-0 text-sm no-underline sm:text-base md:text-lg text-denim cursor-point inline-block">
                            <Link href={'/directory/person/' + values.linkname}>
                                <a href={'/directory/person/' + values.linkname}>{values.first_name + ' ' + values.last_name}</a>
                            </Link>
                    </div>
            ...
            <div className="flex-shrink-0 order-2" onClick={setLikeIndividual}>
                {(session)? <img className="width-25 cursor-point" src={(notification)? star_mark.src: staring.src }/>:null}
        ...
        <div className="pt-2 text-dim-grey">
            ...
            <Link href={'/directory/person/' + values.linkname}>
                <a href={'/directory/person/' + values.linkname}>Learn more about {values.first_name} {values.last_name}</a>
            </Link>
            </div>
        </div>
